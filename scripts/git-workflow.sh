...
# Generic Git workflow script for EmailGenius ConvertKit
...
echo "Starting Git workflow for EmailGenius ConvertKit on '$DEV_BRANCH' branch..."
...
echo "EmailGenius ConvertKit Git workflow (commit & push) completed successfully!"
